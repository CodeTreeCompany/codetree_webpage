      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.ctaSection} ${isVisible ? styles.animateIn : ''}`}>
          <div className={styles.ctaContent}>
            <h3>¿Listo para dar el siguiente paso en tu carrera?</h3>
            <p>Únete al programa de desarrollo profesional y comienza a construir tu futuro con nosotros</p>
        ...
        <div className={styles.modalOverlay} onClick={() => setShowForm(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalHeader}>
              <h2>Postular al programa</h2>
              <p>Completa el formulario y forma parte de nuestro equipo</p>
            </div>

            <form className={styles.postulationForm} onSubmit={handleSubmit}>
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <select name="experience" value={formData.experience} onChange={handleChange} className={formErrors.experience ? styles.error : ''}>
                    <option value="">Selecciona tu nivel</option>
                    <option value="student">Estudiante</option>
                    <option value="junior">Junior (menos de 1 año)</option>
                    <option value="mid">Semi-senior (1-3 años)</option>
                    <option value="career_switch">Cambio de carrera</option>
                  </select>
                  {formErrors.experience && <span className={styles.errorMessage}>{formErrors.experience}</span>}
                </div>
                <div className={styles.formGroup}>
                  <label>Portafolio / GitHub (opcional)</label>
                  <input
                    type="text"
                    name="portfolio"
                    value={formData.portfolio}
                    onChange={handleChange}
                    placeholder="Link a tu portafolio o GitHub"
                  />
                </div>
              </div>

              <div className={styles.formGroup}>
                <label>¿Por qué te interesa el programa? *</label>
                <textarea
                  name="message"
                  rows="4"
                  value={formData.message}
                  onChange={handleChange}
                  placeholder="Cuéntanos sobre ti, tus motivaciones y qué esperas aprender..."
              ...
              <div className={styles.formGroup}>
                <label>Adjuntar CV (opcional)</label>
